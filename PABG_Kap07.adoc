...
====
[#krav-laser-referanserammer-transformasjoner,reftext="Krav laser referanserammer og transformasjoner"]
...
Videre kan primær og/eller sekundærprodukter benyttes til å generere en rekke avledede datasett som for eksempel:
...
Se <<kapittel-eksempel-flyplan-laserskanning>> for et eksempel på en flyplan.
...
====
[#anbefaling-laser-tverrstriper,reftext="Anbefaling laser tverrstriper"]
...
.Eksempel på minste tillate vinkel på tverrstriper
[#imgTverrstriper]
//[caption="Figure 4:"]
image::figurer/Kap7_TverrstripeVinkel.png[Tverrstriper,400,align="center"]

.Eksempel på enkeltstriper i kjede
[#imgEnkeltstripe]
//[caption="Figure 5:"]
...
* Størrelsen på kontrollflaten er avhengig av den planlagte punkttettheten, intensjonen er at hver kontrollflate inneholder minst 20 lasermålinger. Se <<tab-kontrollflate>>. 
* Rundt en kontrollflate skal det være 0,5 m buffersone fri for obstruksjoner.
* En kontrollflate er definert av et gitt antall landmålte punkt. Punktene skal fordeles jevnt som vist i xref:imgKontrollflateUnder[xrefstyle=short],  xref:imgKontrollflateOver[xrefstyle=short] og xref:imgKontrollflateOver70[xrefstyle=short] ut fra planlagt punkttetthet.
...
^| Krav til antall landmålte punkt
^| Planlagt punkttetthet
^|4x4 ^|25 ^|Fra 2 punkt/m^2^
^|2x2 ^|13 ^|Fra 5 punkt/m^2^
^|1,5x1,5 ^|13 ^|Fra 10 punkt/m^2^
^|0,5x0,5 ^|5 ^|Fra 80 punkt/m^2^
|===


.Kontrollflate - punkttetthet fra 2 punkt/m^2^ (Blågrønt felt viser buffersonen, røde prikker er innmålte punkt).
[#imgKontrollflateUnder]
//[caption="Figure 6:"]
image::figurer/Kap7_KontrollflateUnder4.png["Kontrollflater under 3 punkt/m^2^",400,align="center"]

.Kontrollflate - punkttetthet fra 5 punkt/m^2^(Blågrønt felt viser buffersonen, røde prikker er innmålte punkt og hvit felt er malt signal). Ved 10 punkt/m^2^ så er avstanden 0,75 meter ikke 1 meter.
[#imgKontrollflateOver]
//[caption="Figure 7:"]
image::figurer/Kap7_KontrollflateOver4.png["Kontrollflater over 3 punkt/m^2^",400,align="center"]

.Kontrollflate - punkttetthet fra 80 punkt/m^2^ (Blågrønt felt viser buffersonen, røde prikker er innmålte punkt og hvit felt er malt signal).
[#imgKontrollflateOver70]
//[caption="Figure 8:"]
image::figurer/Kap7_KontrollflateOver80.png["Kontrollflater over 70 punkt/m^2^",250,align="center"]
...
* Kontrollflater skal planlegges slik at hele prosjektområdet er dekket av kontrollflatenes gyldighetsområder. Se <<#imgKontrollflateGyldighet>> for et eksempel.
* Antall kontrollflater skal ikke være under et minimum på 3 flater pr. sammenhengende skanneblokk. Oppdragstaker kan slå sammen mindre områder til sammenhengende skanneblokk for å redusere behov for flater. Se <<#imgSammenslåingBlokk>> for et eksempel. 
...
[#krav-laser-kontrollflater-hjulspormetoden,reftext="Krav laser kontrollflater - hjulspormetoden"]
...
* Samme høydereferansemodell (HREF) skal benyttes for innmåling av kontrollflate som for laser punktskyen.
* Landmålingsrapport.

// * Landmålingsarbeidene inkludert rapportering skal utføres i henhold til standarden <<SAT>>.
====

.Figuren viser begge kontrollmetodene: Grønn sirkel angir kontrollflatenes gyldighetsområde, mens lilla viser et eksempel på hjulspor som har en gyldighetsområde på 6 km fra hjulsporet.
[#imgKontrollflateGyldighet]
//[caption="Figure 8:"]
image::figurer/Kap7_KontrollflateGyldighet2.png["Kontrollflate gyldighet",400,align="center"]


.Sammenslåing av polygoner til en skanneblokk
[#imgSammenslåingBlokk]
//[caption="Figure 9:"]
image::figurer/Kap7_SammenslåingBlokk.jpg["Sammenslåing av polygoner til en skanneblokk",400,align="center"]

[[kapittel-kontrollprofiler]]
===== Kontrollprofiler

====
[#krav-laser-kontrollprofiler,reftext="Krav laser kontrollprofiler"]
...
====
[#krav-laser-kontrollprofiler-form-og-storrelse,reftext="Krav laser kontrollprofiler - form og størrelse"]
...
* Samme høydereferansemodell (HREF) skal benyttes for innmåling av kontrollprofil som for laser punktskyen. 
* Landmålingsrapport.

//* Landmålingsrapport, der hvor GNSS er benyttet, skal utføres i henhold til standarden Satellittbasert Posisjonsbestemmelse <<SAT>>.
====
...
====
[#anbefaling-laser-utforing-av-laserskanning,reftext="Anbefaling laser utføring av laserskanning"]
...
====
[#krav-laser-hoydekontroll,reftext="Krav laser høydekontroll"]
...
* Endelig resultat etter eventuell høydejustering skal dokumenteres med høyderapport pr. kontrollflate, samt en sammenfattet oversikt med statistisk informasjon for alle flater. Se <<#imgDokKontrollFL>> og <<tab-statistikk-kontrollFL>>.
* Oppdragstaker skal gi sin vurdering av resultatet.
...
.Eksempel på dokumentasjon pr. kontrollflate
[#imgDokKontrollFL]
//[caption="Figure 11:"]
...
====
[#krav-laser-grunnrisskontroll,reftext="Krav laser grunnrisskontroll"]
...
====
[#krav-laser-kontroll-av-punktsky,reftext="Krav laser kontroll av punktsky"]
...
|Beskrivelse av oppdraget|(produkt, areal og referanse til standarddokumenter) (eventuelle endringer/utvidelser til opprinnelig teknisk spesifikasjon)
...
.2+|Landmålingsrapporter|Rapport innmåling av kontrollflater/hjulspormetoden|Dokumentasjon i henhold til krav stilt i <<kapittel-kontrollflater>>.
...
* IMU:
** Fabrikat, type, serienummer og benyttet loggerate.
* Beskrivelse av hvordan antenneeksentrisitet er bestemt og dokumentasjon av andre eksentrisiteter (for eksempel IMU-montering) +
...
|Progresjon|Oversikt over flydager med skannede flystriper pr. flydag.
...
|Kontroll av punktsky og systematiske avvik|Dokumentasjon i henhold til krav stilt i <<kapittel-kontroll-av-punktsky-systematiske-avvik>>.
|Kontroll av punktsky og homogenitet|Dokumentasjon i henhold til krav stilt i <<kapittel-dokumentasjon-av-homogenitet>>.
|Bearbeiding av laserdata og klassifisering|Dokumentasjon i henhold til krav stilt i <<kapittel-bearbeiding-av-laserdata-klassifisering>>.
