...
Krav til produkt og leveranser spesifiseres i nyeste versjon av Produktspesifikasjon Punktsky <<Punktsky>>. For definisjon av kvalitetsmål vises det til standarden Geodatakvalitet.
