...
* I tilfeller hvor man ikke finner egnet lokasjon for en kvadratisk utformet kontrollflate kan det velges en rektangulær form hvor høyden halveres og størrelsen i m^2^ blir ivaretatt. Et eksempel vil være å endre formen på kontrollflaten fra 4x4 meter til 2x8 meter.
