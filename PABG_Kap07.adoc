...
Krav til produkt og leveranser spesifiseres i nyeste versjon av https://dokument.geonorge.no/produktspesifikasjoner/punktsky/1.0.3/index.html[Produktspesifikasjon Punktsky]. For definisjon av kvalitetsmål vises det til standarden Geodatakvalitet.
...
Gjeldende versjon av https://register.geonorge.no/register/versjoner/produktspesifikasjoner/kartverket/fkb-laser[Produktspesifikasjon Punktsky] detaljerer hvilke klasser som tillates. 
