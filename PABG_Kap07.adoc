...
.7+|Gjennomføring av Laserskanning|Fly|(fabrikat, type, kallesignal, trykkabin ja/nei)
|Skannersystem a|* Skanner: +
** Fabrikat, type, serienummer, eventuelt revisjonsnummer. +
** Leverandørkalibreringer: +
Dokumentasjon i henhold til krav stilt i kap <<Kalibrering av laserskanneren>> +
* Gyromount:	+
** Fabrikat, type. +
* GNSS-mottaker og antenne: +	
** Fabrikat, type, serienummer, benyttet loggerate. +
* IMU: +	
** Fabrikat, type, serienummer, benyttet loggerate. +
