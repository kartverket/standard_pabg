...
* Når det benyttes globale referanserammer, må referansetidspunktet for datafangsten (epoke) være kjent og skal benyttes i transformasjon mellom globale og nasjonale referanserammer. Dette medføre at EPSG koder som utgjøre en samling (ensemble) av EPSG koder ikke skal benyttes.
====
