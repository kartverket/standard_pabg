...
Oppnådd kvalitet på vektordata kartlagt fra punktsky/modell vil være påvirket av flere faktorer. Vi kan skille mellom kvalitetselementer knyttet til punktskyen/modellen som ligger til grunn for vektoriseringen, og kvalitetselementer i selve arbeidet med fremstilling av vektordata fra punktsky.

Kvalitetselementer i punktskyen (jamfør beskrivelser i PaBG – <<kartlegging-med-mobil-datafangst>>):
