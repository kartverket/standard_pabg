...
.Eksempler på ulike datasetts egnethet for vektorisering fra punktsky/modell
[width="100%",options="header"]
|====================
...
Tilsvarende utregning vil gjelde dersom en benytter en bildematchet punktsky, men det må da legges til en faktor fra selve bildematchingen, se xref:imgFormel5[xrefstyle=short].
