...
* Når metoden brukes som alternativ til FKB-kartkonstruksjon vil kvalitetskrav til vektordata følge av kartleggingsstandard og kvalitetsklasser på objekttyper definert i aktuell produktspesifikasjon.
