...
|Klassifisering| Følger krav fra kap 7 samt produksspesifikasjon punktsky. Klassifisering er valgfritt og opp til det enkelte prosjekt å vurdere om relevant og derfor om det skal stilles krav til dette eller ikke.
