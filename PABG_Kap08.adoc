...
|Klassifisering| Følger krav fra <<kapittel-bearbeiding-av-laserdata-klassifisering>> samt https://register.geonorge.no/register/versjoner/produktspesifikasjoner/kartverket/fkb-laser[Produktspesifikasjon Punktsky]. Klassifisering er valgfritt og opp til det enkelte prosjekt å vurdere om relevant og derfor om det skal stilles krav til dette eller ikke.
