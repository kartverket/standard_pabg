...
Målingene for å beregne relativ stedfestningsnøyaktighet utføres langs normalenvektoren til avgrensningens senterpunkt. Relative stedfestningsnøyaktighet deles inn i de to kvalitetsmålene systematisk avvik og tilfeldig variasjon:
