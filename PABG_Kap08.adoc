...
| |Maksimalt avvik 4+^|Systematisk avvik + 2 x Standardavvik
...
|Klassifisering| Følger krav fra <<kapittel-bearbeiding-av-laserdata-klassifisering>> samt [LASER]. Klassifisering er valgfritt og opp til det enkelte prosjekt å vurdere om relevant og derfor om det skal stilles krav til dette eller ikke.
