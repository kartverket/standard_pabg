...
.Figuren viser to ulike skanninger av det samme avgrensningsområdet. Rød pil viser måling som kan inngå i beregning av relative nøyaktighet, systematisk avvik i høyde.
