...
Målingene for å beregne relativ stedfestningsnøyaktighet utføres langs loddlinjen til avgrensningens senterpunkt. Relative stedfestningsnøyaktighet deles inn i de to kvalitetsmålene systematisk avvik og tilfeldig variasjon:
...
|Detaljeringsgrad | Detaljeringsgraden i prosjektet angir krav til definerbarhet av relevante objekter i punktskyen. Detaljeringsgraden stiller krav til punkttetthet.
