...
* Kravene til rapportering beskrevet i <<kapittel-kartlegging-med-flybåren-laserskanning>> (det som er aktuelt for mobil datafangst) - Undersøker muligheten for å lage et dokumentasjonskapitel. 
* Kontrollplan
