...
[#kartlegging-med-mobil-datafangst,reftext="Kartlegging med mobil datafangst"]
...
| |Standardavvik ^|<10 ^|<3 ^|<2 ^|<1 
| |Maks avvik 4+^|Systematisk avvik + 2 x Standardavvik

|Relativ nøyaktighet |  Systematisk avvik  ^| 0 - 200 ^|0 - 20 ^| 0 - 6 ^|0 - 2
