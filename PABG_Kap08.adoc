...
Påføring av fargeverdier på punktskyen, er opsjonelt. Dersom opsjon utløses, bør  kvalitetselementer gitt i <<tab-fargelegging-av-punktsky>> hensyntas:
...
Uavhengig av kontrollmetodikk, skal leverandøren utarbeide en kontrollplan hvor det beskrives hvor store feil kontrollmetodikken er i stand til å avdekke ved kontrollpunktene. Videre skal det angis hvor store feil som kan oppstå mellom kontrollpunktene.

====
[#krav-mobil-kontrollplan,reftext="Krav mobil kontrollplan"]
*KRAV MOBIL KONTROLLPLAN*

* Oppdragstaker skal utarbeide en kontrollplan.
====
