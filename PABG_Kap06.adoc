...
latexmath:[GSD = \frac{c \cdot flyhøyde}{f}]
...
//article{meissner2025adaptable,
//  title={Adaptable Siemens Star Targets for Reliable and //Standardized Spatial Resolution Measurement under DIN 18740-8},
//  author={Mei{\ss}ner, Henry and Berger, Ralf},
