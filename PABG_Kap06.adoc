...
En vikitg faktor ved fotografering fra luften er bildekvalitet. Det er en rekke faktorer som er med på å påvirke vår opplevese av bildekvalitet. Hva som er bra kvalitet vil bestemmes av bruken av bildene. Dersom bildene skal brukes av maskin er informasjonsmengden i bilde viktig, men når menneske skal benytte bildene er det persepsjon som er viktigs. For de fleste tilfeller vil en balangsegang mellom de to tilnærmingene være beste løsning. 

I kvaliatitesmodellen kan vi knytte ulike bildekvalitetsmål til kategorien egenskapkvalitet - Kvantitativ egenskaps nøyaktighet. Noen vil også kunne havne under kategorien egenskapkvalitet - Ikke kvantitativ egenskapsriktighet.
 
===== Oppløsning

Vi skiller mellom to ulike oppløsninger "Ground sample distance (GSD) og Ground Resolved Distance (GRD).

GSD

GSD er avstanden på bakken som tilsvarer en piksel i kameraet. GSD beregnes etter <<formel-GSD>>, hvor c er pikselstørrelsen i kameraets bildesensor, H er flyhøyden over bakken og f er fokallengden til kameraet. 
...
For å beregne GRD må det andvendes en Siemens stjerne innenfor prosjektområdet. Dette er en sirkel bestående av like store svarte of hvite segmenter. Anbfalte antall segmenter følger *[Meißner and Berger, 2025]* og bør ligge mellom 16 og 96 segmenter. Radisuen til stjernen beregnes etter <<formel-radius>>. 
...
| GSD |Teoretisk oppløsning.  | innenfor krav.
| GRD | Bildepikslenes faktiske størrelse i terrenget.  |  Bør sammenfalle med produktets krav til detaljrikdom. 
...
* Kjentpunktene skal måles inn og bestemmes med et standardavvik maksimalt lik ¼ av det strengeste kravet til geodata i det aktuelle prosjektet. For FKB kartlegging se xref:tab-nøyaktighet-innmåling-kjentpunkt-FKB[xrefstyle=short].
...
* Bildene må aerotrianguleres i egnet programvare.
...
* Kontrollen utføres på sluttproduktet (ortofotoet) med minimum 5 uavhengige kontrollpunkt («sjekkpunkter»). Krav til signalerte/naturlige kontrollpunkt skal stå i forhold til nøyaktighetskravene til sluttproduktet. Eksisterende vektordata og ortofoto kan brukes som uavhengige kontrollpunkt der dette er mulig ut ifra kvalitetskravet til sluttproduktet. Nøyaktigheten til kontrollpunktene skal være 1/3 av kravet til nøyaktighet til sluttproduktet.
* Full AT-rapport er ikke nødvendig.
* Ortofotorapport: <<krav-foto-rapportering-ortofoto>>
* Personopplysningsloven skal følges (inkluder GDPR).
====
...
* Bildene må aerotrianguleres i egnet programvare med krav om AT-rapport. <<krav-foto-rapportering-aerotriangulering>>
* Krav til signalerte kjentpunkt og kontrollflater følger kapt. «Fotografering med drone» samt «Kartlegging med flybåren laserskanning».  Kjentpunkt og kontrollflater må være jevnt fordelt ut over blokken/området samt dekke ytterkantene. 
...
* Hvis det gjøres en aerotriangulering så skal AT-rapporten følge  <<krav-foto-rapportering-aerotriangulering>>.
====
