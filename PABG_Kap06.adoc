...
I denne standarden er det formalisert et rammeverk for å kvantifisere bildekvalitetsegenskapene oppløsning og fargenøyaktighet. Dette kan brukes som utgangspunkt for kravstilling i produktspesifikasjon eller bestillingdokumentene.
...
* Det er anbefalt å ha minst 5 kjentpunkter og 3 kontrollpunkter i alle blokkene.
