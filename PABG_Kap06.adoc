...
====
[#krav-foto-kontrollpunkt-antall-og-plassering,reftext="Krav foto kontrollpunkt - Antall og plassering"]
*KRAV FOTO KONTROLLPUNKT - ANTALL OG PLASSERING*

* Nøyaktigheten på resultatet fra AT-en/blokkutjevningen, herunder bildenes ytre orienteringselementer, skal som hovedregel verifiseres ved hjelp av en utjevning med bruk av uavhengige kontrollpunkter ("sjekkpunkter"). Uavhengige kontrollpunkt bidrar ikke til forbedring av orienteringa, men brukes kun til kontroll.
* Kontrollpunktene skal være jevnt fordelt i bildeblokka.
* I blokker med kontrollpunkt så er dette minstekravene til antall kontrollpunkt:
** Minst 2 kontrollpunkter i små blokker med 1 flystripe.
** Minst 3 kontrollpunkter i blokker med færre enn 10 kjentpunkt, men ikke i små blokker med 1 flystripe.
** Minst 30% kontrollpunkter av kravet til antall kjentpunkt i blokker med 10 eller flere kjentpunkt.
...
* Nøyaktigheten på resultatet fra AT-en/blokkutjevningen, herunder bildenes ytre orienteringselementer, skal som hovedregel verifiseres ved hjelp av en utjevning med bruk av uavhengige kontrollpunkter ("sjekkpunkter") jevnt fordelt i bildeblokka. Standardavviket på restavvikene i kontrollpunktene kontrolleres mot kravet til ytre orienteringselementene. I tillegg skal resultatet kontrolleres ved at kjentpunktene (eventuelt et representativt utvalg) måles i stereoinstrument og sammenholdes med gitte koordinater. Deretter kontrolleres standardavviket på avvikene mot kravet til ytre orienteringselementene.
...
Det presiseres at tallene i <<tab-nøyaktighetskrav-AT-FKB>> henviser til kravene som er stilt i FKB 5.1.1 produktspesifikasjonen, ved endringer i FKB spesifikasjonen vil eventuelle endringer til nøyaktighetskrav gjelde foran kravene som er satt opp i <<tab-nøyaktighetskrav-AT-FKB>>.
