...
* Bruk av digitale flybildekamera.
...
====
[#krav-foto-referanserammer-transformasjoner,reftext="Krav foto referanserammer og transformasjoner"]
*KRAV FOTO REFERANSERAMMER OG TRANSFORMASJONER*

* Referanserammer og transformasjoner som er brukt skal følge kravene gitt i <<krav-landmaling-referanserammer-transformasjoner>>.
...
Bakkeoppløsning (GSD) er avstanden på bakken som tilsvarer en piksel i kameraet. GSD beregnes etter xref:imgFormel1[xrefstyle=short], hvor p er pikselstørrelsen i kameraets bildesensor, H er flyhøyden over bakken og f er kamerakonstanten til kameraet. 
...
.: GSD
[#imgFormel1]
image::figurer/Formel_1.png["Formel 1: GSD",align="center"]
...
[caption="Formel 2"]
.: Radius til Siemensstjerne
[#imgFormel2]
image::figurer/Formel_2.png["Radius til Siemensstjerne",align="center"]
...
|====================
|Parameter|Krav
|Bakkeoppløsning (GSD)| Bakkeoppløsning (GSD) bestemmes av oppdragsgiver og velges slik at kravene til fullstendighet og nøyaktighet blir oppfylt. Se xref:tab-FKB-GSD[xrefstyle=short].
|Flyhøyde|Flyhøyden skal velges slik at kravet til bakkeoppløsning (GSD) oppfylles for hver enkelt flystripe. Dersom annet ikke avtales skal GSD refereres til midlere terrenghøyde i hver stripe. Det tillates et planlagt avvik i GSD på maksimalt + 10 %. Eventuelle avvik fra dette skal avtales.
|Bildeblokk|Flystripene skal plasseres optimalt, slik at den resulterende bildeblokken får en mest mulig regulær form og flest mulig parallelt overlappende striper (for å sikre best mulig bildeorientering).

En bildeblokk er en blokk med sammenhengende flybilder. Det er tillatt å fly over vann og sammenbinde flybilder så lenge ukjente parametere er stabile, som kamera og GNSS/INS, og det tas bilder kontinuerlig over vannområdet. 
...
==== Planlegging av kjentpunkt, kontrollpunkt og signalering (signaleringsplan)
Signaleringsplan utarbeides av oppdragstaker som en integrert del av flyfotoplanleggingen og kjentpunktene planlegges slik at plasseringen blir optimal med hensyn til krav til antall, plassering og enkel adkomst. For krav til antall og plassering, se <<kapittel-krav-til-antall-og-plassering-av-kjentpunkter-og-kontrollpunkter>>.
...
[[kapittel-krav-til-kjentpunkter-og-kontrollpunkter]]
===== Krav til kjentpunkter og kontrollpunkter

====
[#krav-foto-kjentpunktnoyaktighet,reftext="Krav foto kjentpunktnøyaktighet og kontrollpunktnøyaktighet"]
...
* Kjentpunktene og kontrollpunktene skal måles inn og bestemmes med et standardavvik maksimalt lik ¼ av det strengeste kravet til geodata i det aktuelle prosjektet. Eksempel for FKB kartlegging se xref:tab-nøyaktighet-innmåling-kjentpunkt-FKB[xrefstyle=short].
...
For krav til utførelse av signaleringen vises det til <<Signalering>>.

[[kapittel-krav-til-antall-og-plassering-av-kjentpunkter-og-kontrollpunkter]]
===== Krav til antall og plassering av kjentpunkter og kontrollpunkter
...
=== Signalering
Dette kapittelet angir krav og retningslinjer til signalering av kjentpunkter for aerotriangulering og eventuelle objekter som skal kartlegges og som er for små til å synes i flybildene. For innmåling av kjentpunkter henvises til krav i <<kapittel-krav-til-kjentpunkter-og-kontrollpunkter>>.

// og til standarden <<SAT>>.
...
Den som signalerer, skal påse at signaleringen utføres i samsvar med gjeldende lover og regler, og at den ikke kommer i konflikt med bestemmelser for fredede eller vernede områder.
...
|Signaleringsstørrelse | Krav til signalstørrelse settes til 2 til 3 ganger GSD, eller etter avtale med oppdragsgiver. Anbefalte signalstørrelser kan sees i <<tab-krav-signalstørrelser>>. Alle typer signaler i <<#imgSignalutforming>> kan benyttes for de forskjellige oppløsningene. For <<#imgSignaler>> vises eksempler på signal som overholder krav til planhet (1) og signaler som ikke overholder krav til planhet (2 og 3).
|Signaltyper a|
.Ulike signaltyper (a, b, c og d)
[#imgSignalutforming]
//[caption="Figure 3:"]
...
====
[#anbefaling-foto-signalstørrelser,reftext="Anbefaling foto signalstørrelser"]
...
|====
^|GSD (cm)
2+^h|Kvadratisk signal (cm)
h| ^h|Størrelse signal ^h|Størrelse med kontrast
^|< 7 ^|21 ^|42
^|7 ^|21 ^|42
^|10 ^|30 ^|60
^|20 ^|60 ^|120
...
.4+|Vedlegg|Signalerte punkt|Koordinatliste for signalerte punkt. Tekst-format med følgende kolonner: [PunkID] [N] [Ø] [H] [dH] 
...
|===
|Moment|Krav
|Bildevandring|Kameraene skal ha digital eller mekanisk bildevandringskompensasjon (FMC). For linjesensorene er ikke dette påkrevd. Alternativt må lukkerhastigheten være så kort at sensorens bevegelse under eksponeringsøyeblikket ikke påvirker bildets kvalitet.
...
|Kameratype|Dersom ikke annet er avtalt skal fotograferingen utføres med geometrisk og radiometrisk kalibrert storformat digitalt kamera. Se <<Krav til kamera>> for krav til instrumenter, kalibrering og kontroll.
...
|Solhøyde|Krav til minste solhøyde under fotografering &#8805; 27^o^ eller etter avtale.
|Skyer og skyskygger a|Krav til maksimalt innhold av skyer og skyskygger under fotografering:
...
|Kamerarotasjoner a|Kameraets tillatte rotasjoner under fotografering:
...
Avvik fra disse kravene kan aksepteres av oppdragsgiver der oppdragstaker kan dokumentere at det ikke medfører kvalitetstap eller problemer i produksjonen. Avviket skal varsles oppdragsvier uten ugrunnet opphold. Avvikene skal beskrives i fotorapporten. 

|Bakkeoppløsning 
a| * Gjennomsnittlig GSD i prosjektområdet: Avtalt verdi
* Maksimal GSD i enkeltbilder: Avtalt verdi + 10 %
...
* Minste sideoverdekning i enkeltbilder: &#8805; 5 % (aksepteres kun lokalt på høyeste topp(er))
|Lengdeoverdekning
...
* Ved sammensetting av det endelige bildesettet i prosjekt der det finnes overlappende versjoner av bilder, skal overskytende bilder fjernes, men ikke hvis de er nødvendige i stripeoverlapp eller det er en grunn til at de må beholdes. Fragmentering av striper eller områder på grunn av fotografering over flere dager skal reduseres til et minimum.
* Filnavn på bilder skal som hovedregel være på formen _FirmaID-Dekningsnr_Stripenr_Bildenr_Kameraløpenr_ (FirmaID er vanligvis to bokstaver) og alle representasjoner av bildene skal benytte/vise til samme filnavn (for eksempel i GNSS/INS-filer, i aerotrianguleringen og i ortofotoproduksjonen).
...
|Sikkerhetsgradering|Oversikt over eventuelle bilder som ikke er levert på grunn av sikkerhetsgradering (jamfør sikkerhetsloven <<SL>>).
...
** Eventuell konvertering til 8 bit radiometrisk oppløsning.
...
* Ugraderte versjoner av graderte bilder skal, når slike er bestilt, være pikselert i henhold til de til enhver tid gjeldende reglene for forbudsområder for luftbårne sensorsystemer.
|====
====
...
* Kravene til sammenbindingspunkt kan avvikes dersom det er absolutt umulig å måle gode punkt. Det er bare delen av overlappen mellom bildene som det er mulig å måle gode punkt i som teller i kravene.
...
* Standardavviket for sammenbindingspunkter og kjentpunkter i selve resultatet av AT-beregningen skal være mindre enn eller lik halvparten av det aktuelle nøyaktighetskravet for geodata.
====
...
^|FKB-Standard
2+^|Krav til geodata, svært veldefinert detalj (cm)
2+^|Krav til punkt i AT-beregning (cm)^1^
2+^|Krav til ytre orienteringselement (cm)^2^
h| ^h|S~p~ ^h|S~z~ ^h|S~p~ ^h|S~z~ ^h|S~p~ ^h|S~z~
^|FKB-A ^|10 ^|10 ^|5 ^|5 ^|7 ^|7
...
_^1^ Med punkt menes sammenbindingspunkt og kjentpunkter og kravet er 1/2 av kravet til geodata i selve AT-beregningen._ +
_^2^ Kravet er 2/3 av kravet til geodata. Det stilles altså samme krav uavhengig av orienteringsmåte; gjennom transformasjon eller direkte bruk av eksisterende ytre orienteringselementer_

:xrefstyle: short

Det presiseres at tallene i <<tab-nøyaktighetskrav-AT-FKB>> henviser til kravene som er stilt i produktspesifikasjonen FKB 5.1.1, ved endringer i FKB produktspesifikasjonen vil eventuelle endringer til nøyaktighetskrav gjelde foran kravene som er satt opp i <<tab-nøyaktighetskrav-AT-FKB>>.
...
====
[#krav-foto-kontrollmaling-i-dfa-av-aerotrianguleringen,reftext="Krav foto kontrollmåling i DFA av aerotrianguleringrn"]
...
* Antall kjentpunkter mottatt inkludert deres opprinnelse, og antall benyttet i AT. +
...
* Oversikt over kjentpunktmålinger som er utelatt i beregningen. +
* Beskrivelse av problemer, inkludert årsaker til disse, som vil eller kan resultere i negative konsekvenser for mellom- og/eller sluttprodukter. +
* Beskrivelse av tilhørende utførte tiltak. +
* Beskrivelse av mulige konsekvenser av problemene.
...
* Gjennomsnittlig standardavvik i sammenbindingspunkt, inkludert maksimalt avvik. +
...
* Ved færre kontrollpunkt enn fem oppgis kun maksimalt avvik.
* Antall kjentpunkter og kontrollpunkter benyttet.
...
* Standardavvik og systematisk avvik av restavvik i kjentpunkter og kontrollpunkter, inkludert maksimalt avvik. +
...
|Egenkontroll|Dokumentasjon av gjennomførte kontroller, i henhold til krav i standarden Geodatakvalitet <<GK>>.
...
====
[#krav-foto-ortofoto-høydemodell,reftext="Krav foto ortofoto høydemodell"]
...
====
[#krav-foto-sant-ortofoto,reftext="Krav foto sant ortofoto"]
...
====
[#krav-foto-ortofotooppløsning,reftext="Krav foto ortofotooppløsning"]
...
====
[#krav-foto-fremstilling-av-ortofoto,reftext="Krav foto fremstilling av ortofoto"]
...
==== Ortofotomosaikk
====
[#krav-foto-ortofotomosaikk,reftext="Krav foto ortofotomosaikk"]
...
|Versjon|(rapportversjonsnummer)
|Datering og signatur|(dd.mm.åååå, signatur)
.10+|Ortofotoproduksjon|Grunnlag a|
* Bildegrunnlag.
* Referanse til aerotrianguleringsrapport.
* Høydedata.
...
* Vektoriseringskapittelet skal følges: <<kapittel-vektorisering-fra-punktsky-og-modell>>
* Personopplysningsloven skal følges (inkludert GDPR).
* Dokumentasjon av kamera og kamerakalibrering:
** Selvkalibrering av kameraet i aerotrianguleringen skal bare bruke parametere som er signifikante.
** Det tillates bruk av tilleggsparametere og korreksjonsgrid.
...
====
[#anbefaling-foto-signalering-i-droneprosjekter,reftext="Anbefaling foto signalering i droneprosjekter"]
...
====
[#krav-foto-minimum-skrabilder,reftext="Krav foto skråbilder kvalitetsnivå minimum"]
...
====
[#anbefaling-foto-skråbilder-minimum,reftext="Anbefaling foto skråbilder kvalitetsnivå minimum"]
...
====
[#krav-foto-lav-skrabilder,reftext="Krav foto skråbilder kvalitetsnivå lav"]
...
====
[#krav-foto-middels-skrabilder,reftext="Krav foto skråbilder kvalitetsnivå middels"]
*KRAV FOTO SKRÅBILDER KVALITETSNIVÅ MIDDELS*

* Vertikalbildene skal tilfredsstille krav til vanlig vertikalbildeprosjekt. Hvis vertikalbildet har mindre enn 20000 piksler i den største retningen, så skaleres minstekravene til sammenbindingspunktene i kravet for vertikalbildene (xref:tab-ant-sammenbindingpkt[xrefstyle=short] og xref:tab-ant-stripesammenbindingpkt[xrefstyle=short]) med størrelsen på vertikalbildet, men ikke mindre enn 12 sammenbindingspunkt mellom påfølgende bilder og ikke mindre enn 4 stripesammenbindingspunkt. Ved for eksempel et vertikalbildekamera med 15000 piksler i den største retningen, så skaleres kravene med 15000/20000 = 0,75.
...
====
[#krav-foto-hoy-skrabilder,reftext="Krav foto skråbilder kvalitetsnivå høy"]
