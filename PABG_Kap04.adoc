...
konsistens, økonomisk verdi og så videre.
...
.landsnett
Overordnet nett av fastmerker som Kartverket vedlikeholder og har ansvaret for <<GG>>. +
_MERKNAD1_: Historisk var koordinatene i Landsnettet en fortetting av koordinatene i Stamnettet, men ved oppdateringer i høyde i 2015 og grunnriss i 2018 er ikke denne koblinga ivaretatt. +
_MERKNAD2_: I dag er Landnettet en samlebetegnelse på både Stamnettet, det opprinnelige Landsnettet og nye overordnede grunnlagspunkt som er etablert. +
_MERKNAD3_: Kartverkets trekantpunkt er ikke en del Landsnettet.
...
.stamnett
Tidligere overordnet nett av fastmerker i Norge, etablert av Statens kartverk i forbindelse med overgang til EUREF89 <<GG>>. +
_Kilde_: Standarden "Koordinatbasert referansesystem" fra 2009. +
