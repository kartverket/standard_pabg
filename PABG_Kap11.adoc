...
=== Originalt materiale
Inntil levering har funnet sted, har oppdragstaker risikoen for alt originalt materiale, inklusive forsvarlig håndtering og midlertidig oppbevaring ref. "Avtale for geodataarbeider". Arkivansvaret overføres til Kartverket ved godkjent levering.
